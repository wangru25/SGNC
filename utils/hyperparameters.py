...
'''
Author: Rui Wang
Date: 2022-11-04 11:53:19
LastModifiedBy: Rui Wang
LastEditTime: 2022-11-04 11:53:20
Email: wangru25@msu.edu
FilePath: /FokkerPlanckAutoEncoder/utils/hyperparameters.py
Description: Helper functions to parse and create a hyperparameter object.
'''
import os
import json
...
def add_arguments(parser):
    ...
    parser.add_argument('-c', '--cell_size',
                        ...
                        default=[128],
                        type=int)
    parser.add_argument('-e', '--emb_size', help='size of bottleneck layer', default=512, type=int)
